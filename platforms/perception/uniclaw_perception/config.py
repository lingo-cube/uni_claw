...
# PER-007 R1：OCR rec 模型直接配置（替代 legacy governance manifest 解析）。
# 受管集 = 唯一 en PP-OCRv4 mobile rec + 字典（uni-agent 物化，dict 已修复
# 至其 manifest 注册的 95 行——PER-005 evidence 留痕）。
_OCR_MODEL_ENV = "UNICLAW_OCR_MODEL"
_DEFAULT_OCR_MODEL = "ocr/models/en_PP-OCRv4_mobile_rec_infer.onnx"
_OCR_DICT_ENV = "UNICLAW_OCR_DICT"
_DEFAULT_OCR_DICT = "ocr/models/en_PP-OCRv4_dict.txt"
...
class PerceptionConfig:
    ...
    def __init__(self) -> None:
        ...
        self.ocr_rec_model: str = str(_resolve_path(_OCR_MODEL_ENV, _DEFAULT_OCR_MODEL))
