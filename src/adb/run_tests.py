...
运行 adb 模块的所有单元测试并生成 AI 可识别的测试报告。
...
输出:
    测试报告: src/adb/test_report.json
    HTML 报告: src/adb/test_report.html
"""
...
def print_report_summary(report: TestReport):
    """打印测试报告摘要。"""
    print("\n" + "=" * 70)
    print(f"ADB 模块单元测试报告 - {report.timestamp}")
    print("=" * 70)
