#!/usr/bin/env python3
"""
Traversal 模块统一单元测试脚本

运行 traversal 模块的所有单元测试并生成 AI 可识别的测试报告。
...
输出:
    测试报告: src/traversal/test_report.json
    HTML 报告: src/traversal/test_report.html
"""
...
def print_report_summary(report: TestReport):
    """打印测试报告摘要。"""
    print("\n" + "=" * 70)
    print(f"Traversal 模块单元测试报告 - {report.timestamp}")
    print("=" * 70)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Traversal 模块单元测试脚本",
