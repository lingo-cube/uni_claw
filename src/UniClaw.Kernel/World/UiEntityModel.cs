...
/// <summary>
/// LogicalItemLifecycle（ADR-0013 四轴中的 Lifecycle 轴）：Established = 连续性
...
/// （UWM-009 §35 / ADR-0013）：revision-local——每个 revision 的 occurrence
...
/// 的 actionable logical referent 有界连续性（ADR-0013）：demand 只购买 tracking
...
/// （UWM-009 §35；ADR-0013 三层模型的中间层）。输入 = 触发本 revision 的
