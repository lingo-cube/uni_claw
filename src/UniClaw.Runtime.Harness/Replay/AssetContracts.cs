...
namespace UniClaw.Runtime.Harness.Replay;

public static class HarnessAssetSchema
{
...
public sealed record Artifact
{
    ...
    /// <summary>
    /// Optional reviewed source path, relative to the containing manifest.
    /// It is a storage locator only and never becomes semantic identity.
    /// </summary>
...
public enum ArtifactType
{
    ...
    RuntimeObservation,
    SemanticDerivation,
    /// <summary>Retained untyped source evidence; never parsed into Runtime facts.</summary>
    SourceEvidence,
}
