...
| Non-Normative Analysis | [Analysis](analysis/) | `NONE`; analysis does not establish a Decision, Contract, gate, or lifecycle | L5 | Retrieve on demand as evidence or design input; follow its cited sources and do not register it as a Decision. |
