...
- **validation-documentation skill**: `.claude/skills/validation-documentation/SKILL.md`
- **测试架构标准化**: `docs/PRD_V6_2_test_architecture_standardization_prd.md`
...
**版本历史**:
- V6.0 (2026-06-06): 初始版本，基于 templates/module_design_template.md
