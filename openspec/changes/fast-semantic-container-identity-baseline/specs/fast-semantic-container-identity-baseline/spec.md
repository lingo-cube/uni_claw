# Spec: fast-semantic-container-identity-baseline

> BASELINE spec for Fast Semantic Container Identity Recovery. No code in this
> change. Base: graduated Semantic Evidence Fusion
> (`docs/decisions/semantic-evidence-fusion-graduation-review.md`).
> Cross-reference: `docs/decisions/fast-semantic-container-identity-baseline.md`.
