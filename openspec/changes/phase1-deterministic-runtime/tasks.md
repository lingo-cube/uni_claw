...
- [ ] C1. §60-F Review checklist（对 SC-P1-001..005 逐一核验）: 无 God Object / 无重复 authority /
...
- [ ] C2. 评审通过后归档本 change（/opsx:archive），提取 decisions（含 裁决 1–11 与本次 Reconciliation 裁决 1–9）
