...
> BASELINE spec for the Runtime-side Assistance seam (L1 CONSULT, External Contract
> Plane 3). No code in this change. Contract frame:
> `runtime-external-contract-baseline`; mother-doc:
