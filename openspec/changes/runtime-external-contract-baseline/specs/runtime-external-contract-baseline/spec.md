...
> Pure-documentation contract baseline for the Runtime ↔ External Intelligence
> Harness boundary. No code, no DTO, no Runtime modification. Every current-reality
> clause is verified repository evidence (2026-08-17). Cross-reference:
