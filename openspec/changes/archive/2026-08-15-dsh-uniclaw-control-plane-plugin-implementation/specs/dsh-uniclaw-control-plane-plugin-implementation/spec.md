# Spec: dsh-uniclaw-control-plane-plugin-implementation

> Spec-driven definition of the DSH↔UniClaw control-plane plugin implementation slice.
> The frozen protocol baseline is authoritative at
> `openspec/changes/archive/2026-08-15-dsh-uniclaw-control-plane-protocol-baseline/`
> and source is pinned at `UNICLAW_DSH_COMPATIBILITY_BASELINE =
