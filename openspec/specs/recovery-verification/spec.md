# recovery-verification Specification
...
### Requirement: Recovery Verification — Capability Spec
...
#### Scenario: SC-P2-003 — Recovery Verification Failure: 未验证不得 Resume

冻结消费者场景契约见 `../../scenarios/SC-P2-003-recovery-verification-failure.md`。
