# runtime-debug-packet-generator Specification

## Purpose
定义从一个显式 Harness capture bundle 生成 Runtime Debug Evidence Packet 的确定性只读能力，以完整 P0 shape 表达 stored facts 与缺失证据，不推断诊断或授权 repair。
