...
| `_visitedChildren` | NavigationContext |
...
- **WHEN** TraversalRuntimeContext fields are counted per subsystem (excluding Phase 3 reserved)
...
- **THEN** SessionContext SHALL have 4 fields (_traceId, _globalState, _deviceExperience, _aiProvider)
- **THEN** ProgressContext SHALL have 5 fields (_stepCount, _maxDepth, _completionPolicy, _actionHistory, _waitAfterActionMs)
- **THEN** CacheContext SHALL have 2 core fields (_pageCache, _cacheValid) + 2 Phase 3 reserved slots
