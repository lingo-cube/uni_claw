...
When ready to implement, ask to apply the change through the available Host workflow.
...
1. **If no clear input provided, ask what they want to build**
   ...
   Use the Host's available user-interaction mechanism to ask:
...
4. **Create artifacts in sequence until apply-ready**
   ...
   Use the Host's available plan/progress mechanism to track the artifacts.
   ...
   c. **If an artifact requires user input** (unclear context):
      - Request a precise user clarification through the available interaction mechanism
...
- Prompt: "Ask me to apply this change to start working on the tasks."
