...
1. **Select the change**
   ...
   - If ambiguous, run `openspec list --json` and request an explicit user selection through the Host's available interaction mechanism

   Always announce: "Using change: <name>" and explain that the user can name another change.
